...
<center> <img src="{{ site.baseurl }}/schemes/heap-replacement.png" alt="The Heap Replacement class" style="width: 40%"/> </center>

A `HeapReplacement` is composed of two sets of [`Identifier`]({{ site.baseurl }}/documentation/symbolic-expressions.html#identifiers)s, the
...
compute their difference, that represents the [`Identifier`]({{ site.baseurl }}/documentation/symbolic-expressions.html#identifiers)s that must be removed from
...
<center> <img src="{{ site.baseurl }}/schemes/sad-state.png" alt="Simple Abstract Domain Lattices" /> </center>
...
[`DomainLattice`]({{ site.baseurl }}/documentation/lattices.html#domain-lattices) operations, `HeapLattice` defines a new method, called `expand`,
...
The [`DomainLattice`]({{ site.baseurl }}/documentation/lattices.html#domain-lattices) instance that models the states generated by the framework
...
this end, LiSA introduces the [`SemanticComponent`]({{ site.baseurl }}/documentation/semantic-domains.html#the-semantic-domain-interface) interface, that matches
[`SemanticDomain`]({{ site.baseurl }}/documentation/semantic-domains.html#the-semantic-domain-interface) except for having an additional parameter, the
[`SemanticOracle`]({{ site.baseurl }}/documentation/semantic-domains.html#the-analysis-class), in all transformers:

<center> <img src="{{ site.baseurl }}/schemes/sad-domain.png" alt="Simple Abstract Domain Components" /> </center>

The [`SemanticOracle`]({{ site.baseurl }}/documentation/semantic-domains.html#the-analysis-class) parameter can effectively be used for cross-component communication,
exploiting the methods it exposes to query information from other components.
[`SemanticComponent`]({{ site.baseurl }}/documentation/semantic-domains.html#the-semantic-domain-interface) has the same type parameters as [`SemanticDomain`]({{ site.baseurl }}/documentation/semantic-domains.html#the-semantic-domain-interface):
...
[`SymbolicExpression`]({{ site.baseurl }}/documentation/symbolic-expressions.html#the-symbolic-expression-class) and can assign values to any [`Identifier`]({{ site.baseurl }}/documentation/symbolic-expressions.html#identifiers), but return a
...
[`SymbolicExpression`]({{ site.baseurl }}/documentation/symbolic-expressions.html#the-symbolic-expression-class)s it can process. This interface inherits from
...
to any [`Identifier`]({{ site.baseurl }}/documentation/symbolic-expressions.html#identifiers). `DomainWithReplacement` provides an
...
The methods of a [`SemanticOracle`]({{ site.baseurl }}/documentation/semantic-domains.html#the-analysis-class) are replicated and split among the three
components, each with an extra parameter for the `state` instance to use for the
computation and a reference to the [`SemanticOracle`]({{ site.baseurl }}/documentation/semantic-domains.html#the-analysis-class) itself for further queries.
...
<center> <img src="{{ site.baseurl }}/schemes/sad-oracle.png" alt="Simple Abstract Domain" style="width: 50%"/> </center>
...
The [`SemanticOracle`]({{ site.baseurl }}/documentation/semantic-domains.html#the-analysis-class) created by `SimpleAbstractDomain` is the `MutableOracle`,
...
<center> <img src="{{ site.baseurl }}/schemes/environment.png" alt="The Environment class hierarchy"/> </center>

An `Environment` is a [`FunctionalLattice`]({{ site.baseurl }}/documentation/lattices.html#powersets-and-functions) that has [`Identifier`]({{ site.baseurl }}/documentation/symbolic-expressions.html#identifiers)s as keys and
...
- `HeapValue`'s `reachableOnlyFrom` instead should perform a cut of the memory
  of the program starting from the given [`Identifier`]({{ site.baseurl }}/documentation/symbolic-expressions.html#identifiers)s, returning all those
  [`Identifier`]({{ site.baseurl }}/documentation/symbolic-expressions.html#identifiers)s that are only reachable from them.
...
<center> <img src="{{ site.baseurl }}/schemes/non-relational.png" alt="Non-Relational Domains" style="width: 80%"/> </center>
...
and on the type `E` of [`SymbolicExpression`]({{ site.baseurl }}/documentation/symbolic-expressions.html#the-symbolic-expression-class)s it can process. Note that the binding
...
- [`SemanticEvaluator`]({{ site.baseurl }}/documentation/semantic-domains.html#the-semantic-domain-interface), that defines a `canProcess` method to check whether the
...
- `NonRelationalHeapDomain`, parametric in the type `L extends HeapValue<L>`
  ...
  and `E` to [`SymbolicExpression`]({{ site.baseurl }}/documentation/symbolic-expressions.html#the-symbolic-expression-class), and that also extends `HeapDomain<HeapEnvironment<L>>`;
  `NonRelationalHeapDomain` is thus a `HeapDomain` that maps [`Identifier`]({{ site.baseurl }}/documentation/symbolic-expressions.html#identifiers)s to
...
- `NonRelationalTypeDomain`, parametric in the type `L extends TypeValue<L>`
  ...
  and `E` to [`ValueExpression`]({{ site.baseurl }}/documentation/symbolic-expressions.html#value-expressions), and that also extends `TypeDomain<TypeEnvironment<L>>`;
  `NonRelationalTypeDomain` is thus a `TypeDomain` that maps [`Identifier`]({{ site.baseurl }}/documentation/symbolic-expressions.html#identifiers)s to
...
- `NonRelationalValueDomain`, parametric in the type `L extends Lattice<L>`
  ...
  and `E` to [`ValueExpression`]({{ site.baseurl }}/documentation/symbolic-expressions.html#value-expressions), and that also extends `ValueDomain<ValueEnvironment<L>>`;
  `NonRelationalValueDomain` is thus a `ValueDomain` that maps [`Identifier`]({{ site.baseurl }}/documentation/symbolic-expressions.html#identifiers)s to
...
using the expressions' visitor pattern through the [`ExpressionVisitor`]({{ site.baseurl }}/documentation/symbolic-expressions.html#the-symbolic-expression-class) interface.
...
<center> <img src="{{ site.baseurl }}/schemes/base-non-relational.png" alt="Base Non-Relational Domains"/> </center>
...
accept and return instances of `M`, which in turn maps [`Identifier`]({{ site.baseurl }}/documentation/symbolic-expressions.html#identifiers)s to instances of `L`.
...
provides default implementations for [`SemanticComponent`]({{ site.baseurl }}/documentation/semantic-domains.html#the-semantic-domain-interface)'s and
...
target of the visit is a [`HeapExpression`]({{ site.baseurl }}/documentation/symbolic-expressions.html#heap-expressions), since such base implementations
...
approach, evaluations of [`Identifier`]({{ site.baseurl }}/documentation/symbolic-expressions.html#identifiers)s through `evalIdentifier` simply return
...
<center> <img src="{{ site.baseurl }}/schemes/dataflow.png" alt="Dataflow Analyses"/> </center>
...
a [`SemanticEvaluator`]({{ site.baseurl }}/documentation/semantic-domains.html#the-semantic-domain-interface), meaning that it can be used in the Simple Abstract Domain
...
that must extend `DataflowElement<E>`, and extends both [`StructuredObject`]({{ site.baseurl }}/documentation/common-interfaces.html#the-structured-representation-interface) and
`ScopedObject<E>`, meaning that it can be converted to a
[`StructuredRepresentation`]({{ site.baseurl }}/documentation/common-interfaces.html#the-structured-representation-interface) for dumping and that it supports scoping operations.
`DataflowElement`s typically track symbolic information that refer to
[`Identifier`]({{ site.baseurl }}/documentation/symbolic-expressions.html#identifiers)s: these can be retrieved using the `getInvolvedIdentifier` method.
