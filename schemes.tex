...
\begin{tikzpicture}[nodes={font={\small}, minimum width=3cm},%
	...
	\node[classnode] (st) [right=of scoped] {\begin{tabular}{l}
			\multicolumn{1}{c}{\textbf{\textit{ScopeToken}}} \\
			\hline
...
\begin{tikzpicture}[nodes={font={\small}, minimum width=3cm},%
	...
	\node[interfacenode] (cl) {\begin{tabular}{l}
			\multicolumn{1}{c}{\underline{\textbf{\textit{CodeLocation}}}} \\
			\hline
			+ getCodeLocation(): String                                    \\
		\end{tabular}};

	\node[interfacenode] (ce) [right=of cl] {\begin{tabular}{l}
			\multicolumn{1}{c}{\underline{\textbf{\textit{CodeElement}}}} \\
			\hline
			+ getLocation(): CodeLocation                                 \\
		\end{tabular}};

	\node[interfacenode] (pp) [below=of ce] {\begin{tabular}{l}
			\multicolumn{1}{c}{\underline{\textbf{\textit{ProgramPoint}}}} \\
			\hline
			+ getCFG(): CFG                                                \\
			+ !getUnit(): Unit                                             \\
			+ !getProgram(): Program                                       \\
...
\begin{tikzpicture}[nodes={font={\small}, minimum width=3cm},%
		...
		abstractclassnode/.style={%
				...
				draw,%
				inner xsep=0},%
		inlinenode/.style={inner xsep=.5cm, minimum height=.6cm}]%
	\node[interfacenode, inlinenode] (lattice) {\underline{\textbf{\textit{Lattice}}} : L};

	\node[interfacenode, inlinenode] (scoped) [right=of lattice] {\underline{\textbf{\textit{ScopedObject}}} : T};
...
\begin{tikzpicture}[nodes={font={\small}, minimum width=3cm},%
		...
		abstractclassnode/.style={%
				...
				inner xsep=0},%
		inlinenode/.style={inner xsep=.5cm, minimum height=.6cm}]%
	\node[interfacenode, inlinenode] (dl) {\underline{\textbf{\textit{DomainLattice}}} : L, T};

	\node[interfacenode, inlinenode] (blattice) [left=of dl] {\underline{\textbf{\textit{BaseLattice}}} : L};

	\node[interfacenode] (lwr) [below=of dl] {\begin{tabular}{l}
			\multicolumn{1}{c}{\underline{\textbf{\textit{LatticeWithReplacement}}} : L} \\
			\hline
	...
	\node[interfacenode, right=of lwr.north east, anchor=north west] (hl) {\begin{tabular}{l}
			\multicolumn{1}{c}{\textbf{\textit{HeapLattice}} : L}  \\
			\hline
			+ expand(base: HeapReplacement): List<HeapReplacement> \\
		\end{tabular}};

	\node[interfacenode, inlinenode, left=of lwr.north west, anchor=north east] (al) {\underline{\textbf{\textit{AbstractLattice}}} : L};

	\node[classnode] (sad) [below=of al] {\begin{tabular}{l}
			\multicolumn{1}{c}{\textbf{\textit{SimpleAbstractState}} : H, V, T} \\
			\hline
			+ heapState: H                                                      \\
			+ valueState: V                                                     \\
			+ typeState: T                                                      \\
	...
	\node[interfacenode, inlinenode] (vl) [below left=1cm and 1.5cm of lwr.south] {\underline{\textbf{\textit{ValueLattice}}} : L};

	\node[interfacenode, inlinenode] (tl) [below right=1cm and 1.5cm of lwr.south] {\underline{\textbf{\textit{TypeLattice}}} : L};
...
\begin{tikzpicture}[nodes={font={\small}, minimum width=3cm},%
	...
	\node[classnode] (sad) {\begin{tabular}{l}
			\multicolumn{1}{c}{\textbf{\textit{SimpleAbstractDomain} : H, V, T}} \\
			\hline
	...
	\node[interfacenode, inlinenode] (dom) [above=of sad] {\underline{\textbf{\textit{AbstractDomain}}} : L};

	\node[classnode] (moracle) [right=of sad] {\begin{tabular}{l}
			\multicolumn{1}{c}{\textbf{\textit{MutableOracle} : H, V, T}} \\
			\hline
			+ heap: H                                                     \\
			+ value: V                                                    \\
			+ type: T                                                     \\
	...
	\node[interfacenode, inlinenode] (oracle) [above=of moracle] {\underline{\textbf{\textit{SemanticOracle}}}};

	\node[classnode, right=of oracle.north east, anchor=north west] (repl) {\begin{tabular}{l}
			\multicolumn{1}{c}{\textbf{\textit{HeapReplacement}}} \\
			\hline
...
\begin{tikzpicture}[nodes={font={\small}, minimum width=3cm},%
	...
	\node[interfacenode] (td) {\begin{tabular}{l}
			\multicolumn{1}{c}{\underline{\textbf{\textit{TypeDomain}}} : L}   \\
			\hline
	...
	\node[interfacenode, inlinenode, left=of td.north west, anchor=north east] (vd) {\begin{tabular}{l}
			\multicolumn{1}{c}{\underline{\textbf{\textit{ValueDmain}}} : L} \\
		\end{tabular}};

	\node[interfacenode] (dwr) [above=1.5cm of $(td)!0.5!(vd)$] {\begin{tabular}{l}
			\multicolumn{1}{c}{\underline{\textbf{\textit{DomainWithReplacement}}} : L, E} \\
			\hline
	...
	\node[interfacenode, left=2cm of dwr.north west, anchor=north east] (hd) {\begin{tabular}{l}
			\multicolumn{1}{c}{\underline{\textbf{\textit{HeapDomain}}} : L}               \\
			\hline
	...
	\node[interfacenode] (comp) [above=of $(hd.north)!0.5!(dwr.north)$] {\begin{tabular}{l}
			\multicolumn{1}{c}{\underline{\textbf{\textit{SemanticComponent}}} : L, T, E, I}                    \\
			\hline
...
\begin{tikzpicture}[nodes={font={\small}, minimum width=3cm},%
	...
	\node[interfacenode, inlinenode] (dl) {\underline{\textbf{\textit{DomainLattice}}} : L, T};
	\node[abstractclassnode, inlinenode] (fl) [right=of dl] {\textbf{\textit{FunctionalLattice}} : F, K, V};

	\node[abstractclassnode, inlinenode] (env) [below=of $(dl.south)!0.5!(fl.south)$] {\textbf{\textit{Environment}} : L, E};
	\node[interfacenode, inlinenode] (vl) [left=of env] {\underline{\textbf{\textit{ValueLattice}}} : L};

	\node[interfacenode, inlinenode] (tl) [right=of env] {\underline{\textbf{\textit{TypeLattice}}} : L};
	\node[interfacenode, inlinenode] (hl) [right=of tl] {\underline{\textbf{\textit{HeapLattice}}} : L};

	\node[classnode, inlinenode] (venv) [below=of vl] {\textbf{\textit{ValueEnvironment}} : L};
	\node[classnode, inlinenode] (tenv) [below=of tl] {\textbf{\textit{TypeEnvironment}} : L};
	\node[classnode, inlinenode] (henv) [below=of hl] {\textbf{\textit{HeapEnvironment}} : L};

	\node[interfacenode, inlinenode] (lattice) [below=of $(tenv.south)!0.5!(henv.south)$] {\underline{\textbf{\textit{Lattice}}} : L};

	\node[interfacenode] (tv) [below right=1cm and -1cm of lattice] {\begin{tabular}{l}
			\multicolumn{1}{c}{\underline{\textbf{\textit{TypeValue}}} : L} \\
			\hline
			+ getRuntimeTypes(): Set<Type>                                  \\
		\end{tabular}};

	\node[interfacenode] (hv) [below left=1cm and -1cm of lattice] {\begin{tabular}{l}
			\multicolumn{1}{c}{\underline{\textbf{\textit{HeapValue}}} : L}                        \\
			\hline
...
\begin{tikzpicture}[nodes={font={\small}, minimum width=5cm, minimum height=.6cm},%
	...
	\node[interfacenode] (eval) {\begin{tabular}{l}
			\multicolumn{1}{c}{\underline{\textbf{\textit{SemanticEvaluator}}}} \\
			\hline
			+ canProcess(expression: SymbolicExpression,                        \\
			$\qquad\qquad$pp: ProgramPoint, oracle: SemanticOracle): boolean    \\
		\end{tabular}};

	\node[interfacenode, inlinenode, right=of eval.south east, anchor=south west] (comp) {\underline{\textbf{\textit{SemanticComponent}}} : L, T, E, I};

	\node[interfacenode] (nrd) [below=of $(eval.south)!0.5!(comp.south)$] {\begin{tabular}{l}
			\multicolumn{1}{c}{\underline{\textbf{\textit{NonRelationalDomain}}}: L, T, M, E}  \\
			\hline
	...
	\node[interfacenode, inlinenode] (td) [below=of nrd] {\underline{\textbf{\textit{TypeDomain}}} : L};
	\node[interfacenode, inlinenode] (nrtd) [below=of td] {\underline{\textbf{\textit{NonRelationalTypeDomain}}} : L};
	\node[interfacenode, inlinenode] (vd) [right=of td] {\underline{\textbf{\textit{ValueDomain}}} : L};
	\node[interfacenode, inlinenode] (nrvd) [right=of nrtd] {\underline{\textbf{\textit{NonRelationalValueDomain}}} : L};
	\node[interfacenode, inlinenode] (hd) [left=of td] {\underline{\textbf{\textit{HeapDomain}}} : L};
	\node[interfacenode, inlinenode] (nrhd) [left=of nrtd] {\underline{\textbf{\textit{NonRelationalHeapDomain}}} : L};
