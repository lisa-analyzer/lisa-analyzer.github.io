...
`getConfiguration` and retrieving the [`FileManager`]({{ site.baseurl }}/documentation/outputs.html#the-filemanager-class) for the analysis through
...
Specifically, given a [`CFG`]({{ site.baseurl }}/documentation/cfgs.html#control-flow-graphs), it can access all generated results of that [`CFG`]({{ site.baseurl }}/documentation/cfgs.html#control-flow-graphs)
as a collection of [`AnalyzedCFG`]({{ site.baseurl }}/documentation/interprocedural-analysis.html#storing-fixpoint-results) instances (read more on the
...
[`Analysis`]({{ site.baseurl }}/documentation/semantic-domains.html#the-analysis-class) executed, enabling the querying of properties of the states stored in
each [`AnalyzedCFG`]({{ site.baseurl }}/documentation/interprocedural-analysis.html#storing-fixpoint-results) through the `satisfies` method or through the
[`SemanticOracle`]({{ site.baseurl }}/documentation/semantic-domains.html#the-analysis-class) methods. Finally, it offers ways to inspect and interact with the
generated [`CallGraph`]({{ site.baseurl }}/documentation/call-graph.html#the-callgraph-class) instance, either by retrieving the instance itself with
`getCallGraph` or by querying its properties through `getCallers`,
`getCallees`, and `getCallSites`. Moreover, given an [`AnalyzedCFG`]({{ site.baseurl }}/documentation/interprocedural-analysis.html#storing-fixpoint-results), it can
access the resolved version of a given [`UnresolvedCall`]({{ site.baseurl }}/documentation/call-graph.html#calls) through
`getResolvedVersion` by inspecting the types reaching the call in the
[`AnalyzedCFG`]({{ site.baseurl }}/documentation/interprocedural-analysis.html#storing-fixpoint-results). All these methods are simply proxies for the ones implemented by
the [`CallGraph`]({{ site.baseurl }}/documentation/call-graph.html#the-callgraph-class) class.
...
can only be used on [`CFG`]({{ site.baseurl }}/documentation/cfgs.html#control-flow-graphs)s. It is parametric on the type `T` of the `tool` to
...
- `visitSubNodesFirst`, that decides whether the sub-nodes of a compound node
  ...
  node itself;
- `visitUnit`, invoked once for each [`Unit`]({{ site.baseurl }}/documentation/units.html#the-unit-class) that is part of the program;
- `visitGlobal`, invoked once for each [`Global`]({{ site.baseurl }}/documentation/units.html#globals) in each [`Unit`]({{ site.baseurl }}/documentation/units.html#the-unit-class) of the program;
- a `visit` overload accepting a graph (i.e., a [`CFG`]({{ site.baseurl }}/documentation/cfgs.html#control-flow-graphs) in the case of `Check`s),
  invoked once for each [`CFG`]({{ site.baseurl }}/documentation/cfgs.html#control-flow-graphs) in the program;
