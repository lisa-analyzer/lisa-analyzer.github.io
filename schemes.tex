...
\begin{tikzpicture}[nodes={font={\small}, minimum width=6cm},%
		...
		abstractclassnode/.style={%
				...
				inner xsep=0},%
		inlinenode/.style={inner xsep=.5cm}]%
	\node[interfacenode] (hd) {\begin{tabular}{l}
			\multicolumn{1}{c}{\underline{\textbf{\textit{HeapDomain}}} : L}                                                               \\
			\hline
			+ rewrite(expression: SymbolicExpression, pp: ProgramPoint,                                                                    \\
			$\qquad\qquad\qquad\qquad$oracle: SemanticOracle): ExpressionSet                                                               \\
			+ rewrite(expressions: ExpressionSet, pp: ProgramPoint, oracle: SemanticOracle): ExpressionSet                                 \\
			+ alias(x: SymbolicExpression, y: SymbolicExpression, pp: ProgramPoint, oracle: SemanticOracle): Satisfiability                \\
			+ reachableFrom(e: SymbolicExpression, pp: ProgramPoint, oracle: SemanticOracle): ExpressionSet                                \\
			+ isReachableFrom(x: SymbolicExpression, y: SymbolicExpression, pp: ProgramPoint, oracle: SemanticOracle): Satisfiability      \\
			+ areMutuallyReachable(x: SymbolicExpression, y: SymbolicExpression, pp: ProgramPoint, oracle: SemanticOracle): Satisfiability \\
		\end{tabular}};

	\node[interfacenode, right=of hd.north east, anchor=north west] (dwr) {\begin{tabular}{l}
			\multicolumn{1}{c}{\underline{\textbf{\textit{DomainWithReplacement}}} : L, E}                 \\
			\hline
			+ !applyReplacement(state: L, r: HeapReplacement, pp: ProgramPoint, oracle: SemanticOracle): L \\
		\end{tabular}};
	...
	\node[classnode, above=of comp.north west, anchor=south west] (sad) {\textbf{\textit{SimpleAbstractDomain} : H, V, T}};

	\node[interfacenode, inlinenode] (dom) [above=of sad] {\underline{\textbf{\textit{SemanticDomain}}} : L, T, E, I};

	\node[classnode, above=of comp.north east, anchor=south east] (moracle) {\textbf{\textit{MutableOracle} : H, V, T}};
