...
components are [`Check`]({{ site.baseurl }}/documentation/checks.html#the-check-interface)s and [`EventListener`]({{ site.baseurl }}/documentation/events.html#event-listeners)s, both through the [`ReportingTool`]({{ site.baseurl }}/documentation/checks.html#tools-for-reporting-issues)
...
A `FileManager` instance is accessible from the [`ReportingTool`]({{ site.baseurl }}/documentation/checks.html#tools-for-reporting-issues) passed to both
[`Check`]({{ site.baseurl }}/documentation/checks.html#the-check-interface)s and [`EventListener`]({{ site.baseurl }}/documentation/events.html#event-listeners)s: thus, both these components can also create output
...
to the [`LiSAConfiguration`]({{ site.baseurl }}/configuration/) used to run the analysis, the collection of generated
...
passed to the analysis. These can access both the [`Application`]({{ site.baseurl }}/documentation/units.html#the-application-unit) analyzed and the
results of the analysis (note that if a semantic analysis has been executed, the
`tool` parameter can be safely cast to [`SemanticTool`]({{ site.baseurl }}/documentation/checks.html#tools-for-reporting-issues) to access the
[`AnalyzedCFG`]({{ site.baseurl }}/documentation/interprocedural-analysis.html#storing-fixpoint-results)s generated by the analysis), as well as any other relevant
information from the already populated `LiSAReport`. Outputs can still generate
warnings and notices by using the given [`ReportingTool`]({{ site.baseurl }}/documentation/checks.html#tools-for-reporting-issues), and they can create
